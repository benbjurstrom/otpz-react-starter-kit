...
This template demonstrates how to integrate the [benbjurstrom/otpz](https://github.com/benbjurstrom/otpz) package with the official [Laravel  + React Starter Kit](https://github.com/laravel/react-starter-kit).
